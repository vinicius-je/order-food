...
const createMenuItem = async (req, res) => {
    const {url, name, description, price, category, time, portion} = req.body;
    const menuItem = new MenuItem({url, name, description, price, category, time, portion});
...
const editMenuItem = async (req, res) => {
    ...
    const {url, name, description, price, category, time, portion} = req.body;
    const menuItemData = {url, name, description, price, category, time, portion}
